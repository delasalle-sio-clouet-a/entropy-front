...
export class SignupForm extends HTMLElement {
    ...
    constructor() {
        ...
        this.cancelButton = this.shadowRoot.getElementById("login-cancel-btn");
        // ajouter les events aux boutons
        this.submitButton.addEventListener("click", (event) => {
            this.submitButton.disabled = true;
            this.cancelButton.disabled = true;
            let pwdInput = this.shadowRoot.getElementById("login-password").value;
            let entropyScore = getEntropyValue(pwdInput);
            let redundancyScore = getRedundancyValue(pwdInput);
        ...
        this.passwordInput.addEventListener("input", (event) => {
            let input = this.shadowRoot.getElementById("login-password").value;
