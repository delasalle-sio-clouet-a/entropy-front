export function getEntropyValue(word) {
    /**
...
export function getRedundancyValue(word) {
    /**
...
export function getEntropyTextForValue(entropyScore) {
    if (entropyScore <= 0) {
        return "Trop faible";
    }
    else if (entropyScore <= 1) {
        return "Très faible";
    }
    else if (entropyScore <= 2) {
        return "Faible";
    }
